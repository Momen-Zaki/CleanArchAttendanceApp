...
using CleanArchAttendanceApp.Web.ContributorEndpoints;
using CleanArchAttendanceApp.Web.Endpoints.ContributorEndpoints;
using Xunit;

namespace CleanArchAttendanceApp.FunctionalTests.ApiEndpoints;
