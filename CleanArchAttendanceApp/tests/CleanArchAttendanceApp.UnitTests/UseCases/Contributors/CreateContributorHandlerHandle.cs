...
using CleanArchAttendanceApp.Core.ContributorAggregate;
using CleanArchAttendanceApp.UseCases.Contributors.Create;
using FluentAssertions;
using NSubstitute;
using Xunit;

namespace CleanArchAttendanceApp.UnitTests.UseCases.Contributors;
