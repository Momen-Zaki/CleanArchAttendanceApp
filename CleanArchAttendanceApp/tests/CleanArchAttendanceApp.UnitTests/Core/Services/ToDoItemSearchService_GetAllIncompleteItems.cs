...
using CleanArchAttendanceApp.Core.ProjectAggregate;
using CleanArchAttendanceApp.Core.Services;
using CleanArchAttendanceApp.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace CleanArchAttendanceApp.UnitTests.Core.Services
{
